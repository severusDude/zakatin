...
<body class="flex flex-col items-center min-h-screen scroll-smooth">
    <header
        class="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-sm transition-all duration-300 hover:bg-white">
        <div class="px-[15%] py-4 w-full flex items-center justify-between">
            <a href="{{ url('/') }}" class="flex items-center gap-2 group">
                <div
                    class="relative w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-lg flex items-center justify-center overflow-hidden animate-[float_3s_ease-in-out_infinite]">
                    ...
                    <span
                        class="text-2xl font-bold text-white relative z-10 transform transition-all duration-500 animate-[glow_2s_ease-in-out_infinite]">Z</span>
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-transparent to-white/20 animate-[shine_3s_ease-in-out_infinite]">
                    </div>
                </div>
                <span
                    class="text-2xl font-bold text-primary-600 group-hover:text-primary-700 transition-all duration-300">Zakatin</span>
            </a>
                        ...
                        <x-nav-link :href="route('home')" :active="request()->routeIs('home')"
                            ...
                            <span class="relative z-10 inline-flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 transform group-hover:rotate-6 transition-transform duration-300"
                            ...
                            <div
                                class="absolute inset-0 bg-primary-50/0 group-hover:bg-primary-50 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left">
                            </div>
                            <div
                                class="absolute bottom-0 left-1/2 w-2 h-2 bg-primary-600 rounded-full transform -translate-x-1/2 scale-0 group-hover:scale-100 transition-transform duration-300">
                            </div>
                        </x-nav-link>
                    </li>
                    <li class="group relative">
            ...
            <button
                class="md:hidden text-gray-700 hover:text-primary-600 focus:outline-none transform hover:scale-110 transition-transform duration-300">
        ...
        <div
            class="hidden md:hidden px-[15%] py-4 bg-white/95 backdrop-blur-md border-t transform transition-all duration-300">
            <ul class="space-y-4">
    ...
    <section style="background-image: url('{{ asset('images/banner.png') }}');"
            ...
            <nav class="flex items-center justify-end gap-4 animate-[fadeInUp_1s_ease-out_0.6s]">
                ...
                <a href="{{ url('/dashboard') }}"
                    ...
                    <span class="flex items-center gap-2">
                        <span>Dashboard</span>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none"
    ...
    <section id="tentang" class="flex flex-col items-center w-full gap-8 py-16 px-[15%]">
        ...
        <div class="mt-12 text-center w-full max-w-3xl">
            <div
                class="relative group p-8 mb-12 border border-primary-200 rounded-2xl bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-500 hover:border-primary-400">
                <div
                    class="absolute -inset-px bg-gradient-to-r from-primary-500 to-primary-700 rounded-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500">
                </div>
                <div class="relative z-10">
                    <h2 class="text-2xl font-semibold text-primary-700 mb-6 relative inline-block">
                        Visi Kami
                        <div
                            class="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-primary-500 to-primary-700 rounded-full transform origin-left">
                        </div>
                    </h2>
                    <p class="text-gray-600 leading-relaxed text-lg group-hover:text-gray-700 transition-colors">
                        Menjadi platform penyaluran zakat terpercaya yang berperan aktif dalam mewujudkan kesejahteraan
                        umat dan mengentaskan kemiskinan di Indonesia.
                    </p>
                </div>
                <div class="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-primary-500 rounded-tl-xl"></div>
                <div class="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-primary-500 rounded-tr-xl">
                </div>
                <div class="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-primary-500 rounded-bl-xl">
                </div>
                <div class="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-primary-500 rounded-br-xl">
                </div>
            </div>


            <div
                class="relative group p-8 border border-primary-200 rounded-2xl bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-500 hover:border-primary-400">
                <div
                    class="absolute -inset-px bg-gradient-to-r from-primary-500 to-primary-700 rounded-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500">
                </div>
                <div class="relative z-10">
                    ...
                    <ul class="text-gray-600 space-y-4">
                        <li
                            class="group/item flex items-center gap-3 p-3 rounded-xl border border-primary-100 hover:border-primary-300 hover:bg-primary-50/50 transition-all duration-300">
                            <span
                                class="w-2 h-2 bg-primary-500 rounded-full group-hover/item:scale-150 transition-transform duration-300"></span>
                            <span class="text-left">Menghimpun dan menyalurkan dana zakat secara profesional,
                        ...
                        <li
                            ...
                            <span
                                class="w-2 h-2 bg-primary-500 rounded-full group-hover/item:scale-150 transition-transform duration-300"></span>
                            <span class="text-left">Memudahkan akses masyarakat dalam menunaikan kewajiban
                                berzakat</span>
                        </li>
                        <li
                            class="group/item flex items-center gap-3 p-3 rounded-xl border border-primary-100 hover:border-primary-300 hover:bg-primary-50/50 transition-all duration-300">
                            <span
                                class="w-2 h-2 bg-primary-500 rounded-full group-hover/item:scale-150 transition-transform duration-300"></span>
                            <span class="text-left">Mengedukasi masyarakat tentang pentingnya zakat dalam kehidupan
                                sosial dan ekonomi</span>
                        </li>
                    </ul>
                </div>
                <div class="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-primary-500 rounded-tl-xl"></div>
    ...
    <footer class="w-full bg-gradient-to-br from-primary-900 to-primary-800 text-white py-16 relative overflow-hidden">
        ...
        <div class="absolute inset-0">
            <div class="absolute w-96 h-96 bg-primary-700/10 rounded-full -top-48 -left-48 blur-3xl animate-pulse">
            </div>
            <div
                class="absolute w-96 h-96 bg-primary-800/10 rounded-full -bottom-48 -right-48 blur-3xl animate-pulse delay-1000">
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="mb-6 group">
                    <h3 class="text-xl font-bold mb-4 relative inline-block">
                        {{ config('app.name') }}
                        <div
                            class="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary-500 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-300">
                        </div>
                    </h3>
                    <p class="text-gray-300 group-hover:text-white transition-colors duration-300">
                        Platform penyaluran zakat terpercaya untuk membantu mereka yang membutuhkan dengan cara yang
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-semibold mb-6 relative inline-block group-hover:text-white">
                        Kontak
                        <div
                            class="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary-500 to-transparent">
                        </div>
                    </h3>
                    <ul class="space-y-4 text-gray-300">
                        <li class="group flex items-start gap-3 hover:translate-x-2 transition-all duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 mt-0.5 flex-shrink-0 text-primary-400 group-hover:text-primary-300 transition-colors"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li class="group flex items-center gap-3 hover:translate-x-2 transition-all duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 flex-shrink-0 text-primary-400 group-hover:text-primary-300 transition-colors"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mb-6">
                    ...
                    <div class="flex space-x-6">
                        <a href="#" class="group">
                            <div
                                class="relative p-3 rounded-full bg-primary-800/50 hover:bg-primary-700/50 transition-all duration-300 overflow-hidden">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-primary-500/20 to-primary-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                </div>
                                <svg class="h-6 w-6 text-gray-300 group-hover:text-white transition-colors relative z-10 group-hover:scale-110 transform duration-300"
